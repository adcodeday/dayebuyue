...
public class RedisUtil {
    ...
    private static final String LUA_INCR_EXPIRE =
            "local key,ttl=KEYS[1],ARGV[1] \n" +
                    ...
                    "end ";
    private static final String GET_THEN_DELETE = """
    ...
    private static final String DELETE_IF_EXITES = "if redis.call('EXISTS', KEYS[1]) == 1 then" +
...
//    public static String getThenDelete(String key){
//        return stringRedisTemplate.execute(new DefaultRedisScript<>(GET_THEN_DELETE, String.class),
//                Collections.singletonList(key));
//    }
//
    public static Boolean deleteIfExists(String key){
        Boolean result = (Boolean) stringRedisTemplate.execute(new DefaultRedisScript<>(DELETE_IF_EXITES, Boolean.class),
                Collections.singletonList(key));
